...
public class ApiTx0Preview {
  ...
  public ApiTx0Preview(Tx0Preview tx0Preview) {
    this.poolId = tx0Preview.getPool().getPoolId();
    ...
    this.message = tx0Preview.getTx0Data().getMessage();
  }
