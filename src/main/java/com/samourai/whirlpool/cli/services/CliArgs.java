...
public class CliArgs {
  ...
  public static final String ARG_RESTORE_BACKUP = "restore-backup";
  public static final String ARG_RESTORE_EXTERNAL = "restore-external";
  ...
  public CliArgs(ApplicationArguments args) {
    this.args = args;
  }
  ...
  public boolean isCreate() {
    return args.containsOption(ARG_CREATE);
  }

  public boolean isRestoreBackup() {
    return args.containsOption(ARG_RESTORE_BACKUP);
  }

  public boolean isRestoreExternal() {
    return args.containsOption(ARG_RESTORE_EXTERNAL);
  }
